...
if ($transport->xpdo) {
    ...
    switch ($options[xPDOTransport::PACKAGE_ACTION]) {
        ...
        case xPDOTransport::ACTION_UPGRADE:
            $modx->addPackage('jqueryvalidate', MODX_CORE_PATH . 'components/jqueryvalidate/model/');
            $manager = $modx->getManager();
            $objects = [];
            $schemaFile = MODX_CORE_PATH . 'components/jqueryvalidate/model/schema/jqueryvalidate.mysql.schema.xml';
